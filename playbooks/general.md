...
**Worker self-check.** Confirm one outcome. Then run the same product-line count. If this PR has a second outcome or ≥800 added product lines, do not open a megadiff PR; split first or report `AWAITING SPLIT`.
